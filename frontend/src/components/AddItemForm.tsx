  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      >
        ...
        <span className="inline-flex items-center gap-1 rounded-lg bg-indigo-50 px-3 py-1.5 text-sm font-medium text-indigo-700">
      ...
      {open && (
        <form onSubmit={(e) => void handleSubmit(e)} className="border-t border-slate-100 px-5 py-5">
          {error && (
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <label className="block text-sm">
              ...
              <input
                ...
                placeholder="WH-009"
                className="w-full rounded-lg border border-slate-200 px-3 py-2 font-mono text-slate-900 uppercase outline-none ring-indigo-500 focus:ring-2"
              />
            </label>
            ...
            <label className="block text-sm">
              <span className="mb-1 block font-medium text-slate-700">Current stock</span>
              <input
                type="number"
                min={0}
            ...
            <label className="block text-sm">
              <span className="mb-1 block font-medium text-slate-700">Min threshold</span>
              <input
                type="number"
                min={0}
