...
export default function DashboardCharts({ items, summary }: DashboardChartsProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm md:col-span-2 dark:border-slate-700 dark:bg-slate-800">
        <h3 className="mb-4 text-sm font-semibold text-slate-700 dark:text-slate-300">
          Stock Levels vs. Min Threshold (Lowest 10)
        </h3>
        <ResponsiveContainer width="100%" height={250}>
          <BarChart data={stockVsThreshold} margin={{ left: 0, right: 10, bottom: 20 }}>
